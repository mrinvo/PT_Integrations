<html>
                ...
                <div class="checkout">
                    ...
                    <div class="payment">
                        ...
                        <div class="content">
                            ...
                            <form id="payform" action="/payment/managed" method="POST">
                                    @csrf
                                ...
                                <div class="ay">
                                    <div class="cardHolderName wid">
                                        ...
                                        <div class="exp">
                                            <input type="text" placeholder="MM" data-paylib="expmonth" size="2">
                                            <input type="text" placeholder="YYYY" data-paylib="expyear" size="4">
                                        </div>
                                    ...
                                    <div class="cardHolderName wid">
                                        ...
                                        <input style="width:55%; height:36px;" type="text" placeholder="CVV" data-paylib="cvv" size="4">
                                    </div> <!-- CVV -->
                                </div>
                                ...
                                <div class="security">
                                    ...
                                    {{-- static inputs field --}}
                                    <input hidden type="text" name="payment_type" value="managed">
    ...
    <script type="text/javascript">
        ...
        paylib.inlineForm({
          'key': 'CNKMHT-9HBN6D-TBBPNG-KQP2P7',
          'form': myform,
          'autoSubmit': true,
