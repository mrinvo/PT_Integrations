                    ...
                    <div class="payment">
                        ...
                        <div class="content">
                            <div class="infos">
                                ...
                                <div class="method">
                                    <h2>Follow up transaction: Cancel Invoice</h2>
                                </div> <!-- .method -->
                            ...
                            <form id="myForm" action="/payment/invoice/cancel" method="POST">
                                    @csrf
                                ...
                                <div class="security">
                                    ...
                                    {{-- static inputs field --}}
                                    <input hidden type="text" name="payment_type" value="cancel">
