                    ...
                    <div class="payment">
                        ...
                        <div class="content">
                            <div class="infos">
                                ...
                                <div class="method">
                                    <h2>Follow up transaction: Query</h2>
                                </div> <!-- .method -->
                            ...
                            <form id="myForm" action="/payment/query" method="POST">
                                    @csrf
                                ...
                                <div class="security">
                                    ...
                                    {{-- static inputs field --}}
                                    <input hidden type="text" name="payment_type" value="query">
                                ...
                                <input type="submit" value="Query" class="sub">
