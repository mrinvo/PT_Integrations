                    ...
                    <div class="payment">
                        ...
                        <div class="content">
                            <div class="infos">
                                ...
                                <div class="method">
                                    <h2>Follow up transaction: Void</h2>
                                </div> <!-- .method -->
                            ...
                            <form id="myForm" action="/payment/void" method="POST">
                                    @csrf
                                ...
                                <div class="security">
                                    ...
                                    {{-- static inputs field --}}
                                    <input hidden type="text" name="payment_type" value="void">
                                ...
                                <input type="submit" value="Void" class="sub">
