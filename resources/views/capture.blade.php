                    ...
                    <div class="payment">
                        ...
                        <div class="content">
                            <div class="infos">
                                ...
                                <div class="method">
                                    <h2>Follow up transaction: Capture</h2>
                                </div> <!-- .method -->
                            ...
                            <form id="myForm" action="/payment/capture" method="POST">
                                    @csrf
                                ...
                                <div class="customerDetailsWrapper">
                                    ...
                                    <div class="cardHolderName">
                                        <p class="title">Capture Amount</p>
                                ...
                                <div class="security">
                                    ...
                                    {{-- static inputs field --}}
                                    <input hidden type="text" name="payment_type" value="capture">
                                ...
                                <input type="submit" value="Capture" class="sub">
