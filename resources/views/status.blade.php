                    ...
                    <div class="payment">
                        ...
                        <div class="content">
                            <div class="infos">
                                ...
                                <div class="method">
                                    <h2>Follow up transaction: Get Invoice Status</h2>
                                </div> <!-- .method -->
                            ...
                            <form id="myForm" action="/payment/invoice/status" method="POST">
                                    @csrf
                                <h3 class="customerDetailsTitle">Invoice Details</h2>
                                <div class="customerDetailsWrapper">
                                    <div class="cardHolderName">
                                        <p class="title">Invoice ID</p>
                                        <input value="" type="text" name="invoice_id">
                                    </div> <!-- cardHolderName -->
                                ...
                                <div class="security">
                                    ...
                                    {{-- static inputs field --}}
                                    <input hidden type="text" name="payment_type" value="status">
                                ...
                                <input type="submit" value="Get Status" class="sub">
